...
/* ================= CONSTANTS ================= */
// TODO: replace with the brokerage's real contact details — same
// placeholders used in Navbar / menuItems.
const CONTACT_PHONE = "+1 (202) 555-0198";
const CONTACT_EMAIL = "hello@meridianhomes.com";
const OFFICE_ADDRESS = "480 Market Street, Denver, CO 80202";
...
// TODO: swap in the brokerage's real social profile URLs
const SOCIAL_LINKS = [
...
const CERTIFICATIONS = [
  { icon: BadgeCheck, label: "Licensed Real Estate Brokerage" },
  { icon: ShieldCheck, label: "Verified & Trusted Agents" },
];
