  ...
  },
  {
    ...
    icon: (active) => (
      ...
      >
        ...
        <path d="M9 20v-5h6v5" />
        <path d="M9 13h.01M15 13h.01M12 13h.01" />
      </svg>
    ),
  },
  {
    ...
    >
      <div className="relative mx-auto max-w-md">
        ...
        <button
          ...
          className="absolute  left-1/2 -top-6 z-50 flex h-14 w-14 -translate-x-1/2 cursor-pointer items-center justify-center rounded-full bg-accent-500 text-white shadow-xl transition hover:scale-105 hover:bg-accent-600 ring- ring-white"
        >
          {isChatOpen ? (
