...
const PropertyListingCard = ({ property }: { property: PropertyListing }) => {
  ...
  return (
    <article className="group overflow-hidden rounded-2xl border border-brand-900/10 bg-white shadow-sm transition hover:shadow-lg">
      ...
      <div className="p-5">
        ...
        <h3 className="mt-1 font-bold text-brand-900">{property.title}</h3>
